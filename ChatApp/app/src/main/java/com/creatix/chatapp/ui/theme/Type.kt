...
// نستخدم خط النظام الافتراضي لكن بأوزان وتباعد أحرف مضبوطة بعناية
// عشان تدي إحساس احترافي بدون الحاجة لخطوط خارجية.

val Typography = Typography(
    displaySmall = TextStyle(fontWeight = FontWeight.Bold, fontSize = 34.sp, lineHeight = 40.sp, letterSpacing = 0.sp),
    headlineMedium = TextStyle(fontWeight = FontWeight.ExtraBold, fontSize = 26.sp, lineHeight = 32.sp, letterSpacing = 0.sp),
